    ...
    return(
        ...
        <div className='contact'>
            ...
            <div className='menu-footer'>
                <p>Menu</p>
                <ul>
                <li><Link id="navigationLink" smooth to="/" className='links-footer'>Home</Link></li>
                <li><Link id="navigationLink" smooth to="/specials" className='links-footer'>Specials</Link></li>
                <li><Link id="navigationLink" smooth to="/massages" className='links-footer'>Massage</Link></li>
                <li><Link id="navigationLink" smooth to="/contact" className='links-footer'>Contact</Link></li>
                </ul>
            </div>
